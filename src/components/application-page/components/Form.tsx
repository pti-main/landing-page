...
const Form = (props:any) => {
	...
	let stages = [
		...
		<Sent resetForm={true} success={true}/>
	];
	...
	const handleButtonClick = (action:string, stagesAmount:number) => {
		...
		window.scrollTo({
			behavior: "smooth",
			top: 0
		}); //thats a kozak lajn of kod || i myslec chicken
		...
		<div id="form">
			<div className="container">
				...
				<div className="inner__container">
					...
					<Information fadeTransition={fadeTransition}/>

					<animated.div style={fadeTransition} className="stage">  
							{ stages[currentStage] }
					</animated.div>
					<animated.div style={fadeTransition} className="animated__buttons">

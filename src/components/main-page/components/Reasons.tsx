    ...
    return (
        <div id="reasons">
            <div className="container">
                ...
                <div className="description">testowy opis zobaczyc jak to wyjdzie: marchewka lorem ipsum kino jest zdjęciem, zycie jest bledem elo. -- testowy opis zobaczyc jak to wyjdzie: marchewka lorem ipsum kino jest zdjęciem, zycie jest bledem elo.</div>
                <div className="content">
                    <div className="reasons-embed">
                        ...
                        <div className="reasons-description">
                            testowy opis zobaczyc jak to wyjdzie: marchewka lorem ipsum kino jest zdjęciem, zycie jest bledem elo.
                        </div>
                    </div>
                    <div className="reasons-embed">
                        <div className="reasons-icon">
                    ...
                    <div className="reasons-embed">
                        <div className="reasons-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" role="img" viewBox="0 0 512 512"><path fill="currentColor" d="M464 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48zM224 416H64V160h160v256zm224 0H288V160h160v256z"/></svg>
                        </div>
                        <div className="reasons-title">
                            Web Development
                        </div>

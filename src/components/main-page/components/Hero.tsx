...
const Hero = (props:any) => {
    return (
        <div id="hero" className="hero">
            ...
            <VizSensor partialVisibility={true} onChange={(isVisible:any) => {
                document.querySelectorAll("video")[0][isVisible ? "play" : "pause"]();
            }}>
            ...
            <video style={{opacity: 0}} className="hero__video" preload="metadata" playsInline loop muted onLoadedMetadata={(e) => {
                e.currentTarget.play()
                    ...
                    .catch((err) => console.warn(`User can't play video, because no. (really the problem is: rejected promise: "${err}" (propably user have turned on power saving mode))`));
            }}> 
            ...
            <div className="container">
                ...
                <div className="container__buttons">
                    ...
                    <Link to="/aplikuj" style={{textDecoration: 'none'}}>
                        <button className="buttons__application buttons">
                            Dołącz do nas
                        </button>
                    </Link>
                    
                    <Scroll to="reasons" spy={true} smooth="easeInOutCubic" offset={-80} duration={700}>
